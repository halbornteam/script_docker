...
update_cert () {
	...
	[Service]
	Environment="HTTP_PROXY=http://10.0.0.4:3128/"
	Environment="HTTPS_PROXY=http://10.0.0.4:3128/"
	EOD

	# Get the cert
	curl http://10.0.0.4:3128/ca.crt > /usr/share/ca-certificates/docker_registry_proxy.crt
